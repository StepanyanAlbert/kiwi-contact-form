...
class KiwiCfIntegration {
	...
	public function add_service( $name, Kiwi_CF_Service $service ) {
...
abstract class Kiwi_CF_Service {
...
class Kiwi_CF_Service_OAuth2 extends Kiwi_CF_Service {
	...
	protected function menu_page_url( $args = '' ) {
		return menu_page_url( 'kiwi-integration', false );
	}
	...
	protected function log( $url, $request, $response ) {
		kiwi_cf_log_remote_request( $url, $request, $response );
	}
