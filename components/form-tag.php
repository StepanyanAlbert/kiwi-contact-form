...
class KiwiCfFormTag implements ArrayAccess {
	...
	public function get_default_option( $default = '', $args = '' ) {
		...
		foreach ( $options as $opt ) {
			...
			and is_user_logged_in() ) {
				...
				$vals = array_map( 'kiwi_cf_sanitize_query_var', $vals );
				...
				if ( $contact_form = KiwiContactForm::get_current() ) {
	...
	public function get_data_option( $args = '' ) {
		...
		return apply_filters( 'kiwi_cf_form_tag_data_option', null, $options, $args );
	}
