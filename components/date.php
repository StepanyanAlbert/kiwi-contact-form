    ...
    <tr>
        <th scope="row">
            <label for="<?php echo esc_attr( $args['content'] . '-values' ); ?>">
                <?php echo esc_html( __( 'Start Date', 'kiwi-contact-form' ) ); ?>
            </label>
        </th>
        <td>
            <input type="date" name="min" class="date option" style="width: 200px" />
        </td>
    </tr>
    <tr>
        <th scope="row">
            <label for="<?php echo esc_attr( $args['content'] . '-values' ); ?>">
                <?php echo esc_html( __( 'End Date', 'kiwi-contact-form' ) ); ?>
            </label>
        </th>
        <td>
            <input type="date" name="max" class="date option" style="width: 200px" />
        </td>
    </tr>
